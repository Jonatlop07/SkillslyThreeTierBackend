...
import { CreatePermanentPostService } from '@core/service/permanent-post/create_permanent_post.service';
import { QueryPermanentPostService } from '@core/service/permanent-post/query_permanent_post.service';
import { QueryPermanentPostCollectionService } from '@core/service/permanent-post/query_permanent_post_collection.service';
import { UpdatePermanentPostService } from '@core/service/permanent-post/update_permanent_post.service';
...
import { SharePermanentPostService } from '@core/service/permanent-post/share_permanent_post.service';
...
import { DeletePermanentPostService } from '@core/service/permanent-post/delete_permanent_post.service';
...
import {
  QueryProjectCollectionService
} from '@core/service/project/query_project_collection.service';
...
import { GetPermanentPostCollectionOfFriendsService } from '@core/service/permanent-post/get_permanent_post_collection_of_friends.service';
  ...
  return await Test.createTestingModule({
    providers: [
      ...
      },
      {
        ...
        useFactory: (query_gateway, delete_gateway) => new DeleteTemporalPostService(delete_gateway),
      ...
      },
      {
        ...
        useFactory: (gateway, user_gateway) => new QueryProjectCollectionService(gateway, user_gateway),
