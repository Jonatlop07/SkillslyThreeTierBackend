...
export class CreateCommentInCommentService implements CreateCommentInCommentInteractor {
  constructor(@Inject(CommentDITokens.CommentInCommentRepository) private readonly gateway: CreateCommentInCommentGateway) {
  }

  async execute(input: CreateCommentInCommentInputModel): Promise<CreateCommentInCommentOutputModel> {
