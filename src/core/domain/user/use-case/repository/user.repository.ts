...
import CreateUserFollowRequestGateway
  from '@core/domain/user/use-case/gateway/follow_request/create_user_follow_request.gateway';
import DeleteUserFollowRequestGateway
  from '@core/domain/user/use-case/gateway/follow_request/delete_user_follow_request.gateway';
...
import GetUserFollowRequestCollectionGateway
  from '@core/domain/user/use-case/gateway/follow_request/get_user_follow_request.gateway';
