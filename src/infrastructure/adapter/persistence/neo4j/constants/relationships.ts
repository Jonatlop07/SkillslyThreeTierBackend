export class Relationships {
  ...
  public static readonly APPLICANT_SERVICE_REQUEST_EVALUATION_RELATIONSHIP = 'EVALUATED_FOR';
  public static readonly SERVICE_PROVIDER_SERVICE_REQUEST_RELATIONSHIP = 'PROVIDES';
  public static readonly SERVICE_REQUEST_COMPLETION_REQUESTED_RELATIONSHIP = 'REQUESTS_COMPLETION';
  public static readonly SERVICE_REQUEST_CANCEL_REQUESTED_RELATIONSHIP = 'REQUESTS_CANCELLING';
  public static readonly SERVICE_REQUEST_CLOSED_RELATIONSHIP = 'CLOSED';
  public static readonly COMMENT_COMMENT_RELATIONSHIP = 'LINKED_TO';
}
